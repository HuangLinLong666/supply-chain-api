...
> 生成时间（UTC）：`2026-07-26T03:22:02.769488+00:00`  
> 模式：`dry-run`  
...
- 完整 JSON 备份：`artifacts/risk_cleanup_backup_20260726T032202Z.json`。
- 中文统计报告：`artifacts/risk_recalculation_report_20260726T032202Z.md`。
