...
> 生成时间（UTC）：`2026-07-26T03:03:21.176457+00:00`  
> 模式：`execute`  
...
- 执行状态：`completed`。
- 无 Provider 的合成 `RiskFactor` 删除候选：**612**。
- 需按运输方式重算的 `RouteSegment`：**613**。
- 需清空无来源通用风险字段的其他节点：**129**。
- 计划指纹：`fa5053776a4d7a77eb9f0f0f30e2e8cdad1fe7b93a6270c9ddc6df90bd915fb4`。
...
|---|---|---|
| air | unavailable | 10 |
| delivery | unavailable | 82 |
| multimodal | unavailable | 390 |
| rail | unavailable | 17 |
| road | unavailable | 91 |
| sea | partial | 5 |
| sea | unavailable | 18 |
...
| 标签 | 迁移前 | 迁移后 |
|---|---|---|
| NewsRiskEvent | 11946 | 11946 |
| NewsRiskZone | 10 | 10 |
| PortTrafficSnapshot | 0 | 0 |
| Shipment | 1 | 1 |
| Vessel | 1 | 1 |
...
- 完整 JSON 备份：`artifacts/risk_cleanup_backup_20260726T030321Z.json`。
- 中文统计报告：`artifacts/risk_recalculation_report_20260726T030321Z.md`。
