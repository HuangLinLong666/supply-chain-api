...
> 生成时间（UTC）：`2026-07-26T02:28:04.260492+00:00`  
> 模式：`execute`  
...
| Factory | 19 | 19 |
| Warehouse | 6 | 42 |
| TransportLocation | 7 | 102 |
| Port | 20 | 20 |
| Airport | 16 | 16 |
| RailTerminal | 5 | 5 |
| RoadTerminal | 0 | 0 |
| RouteSegment | 594 | 613 |
| Route | 26 | 26 |
| GeoZone | 0 | 10 |
| RiskObservation | 0 | 11989 |
| CostObservation | 0 | 609 |
| DelayObservation | 0 | 628 |
| Evidence | 0 | 11957 |
| Vessel | 1 | 1 |
| PortTrafficSnapshot | 0 | 0 |
| RecommendationSnapshot | 0 | 0 |

## 8. 产物

- JSON：`artifacts/unified_schema_migration_20260726T022804Z.json`。
- Markdown：`artifacts/unified_schema_migration_20260726T022804Z.md`。
