...
> 生成时间（UTC）：`2026-07-26T02:05:27.245288+00:00`  
> 模式：`dry-run`  
> 数据库：`94a63264`  
...
- 机器可读备份：`artifacts/database_cleanup_backup_20260726T020527Z.json`。
- 本报告：`artifacts/database_cleanup_report_20260726T020527Z.md`。
