...
> 生成时间（UTC）：`2026-07-26T02:24:18.152606+00:00`  
> 模式：`dry-run`  
...
- 状态：`dry_run`。
- 删除节点：**0**；删除关系：**0**。
- 计划指纹：`1dc7f497f8a30f770f5304652a70c0e00577766743d62be9768f3e13e3ada33a`。
- 预计规范化节点：**14018**。
- 预计新增兼容关系：**0**。
...
- JSON：`artifacts/unified_schema_migration_20260726T022418Z.json`。
- Markdown：`artifacts/unified_schema_migration_20260726T022418Z.md`。
