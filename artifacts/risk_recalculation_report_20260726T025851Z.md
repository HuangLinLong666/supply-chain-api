...
> 生成时间（UTC）：`2026-07-26T02:58:51.613265+00:00`  
> 模式：`dry-run`  
...
- 执行状态：`dry_run`。
- 无 Provider 的合成 `RiskFactor` 删除候选：**605**。
- 需按运输方式重算的 `RouteSegment`：**613**。
- 需清空无来源通用风险字段的其他节点：**129**。
- 计划指纹：`88a9f9fea297fb52dc8815e7fff18f680580b3e96fb6c12470300c5423566623`。
...
- 完整 JSON 备份：`artifacts/risk_cleanup_backup_20260726T025851Z.json`。
- 中文统计报告：`artifacts/risk_recalculation_report_20260726T025851Z.md`。
