...
> 生成时间（UTC）：`2026-07-26T03:21:12.216156+00:00`  
> 模式：`execute`  
...
- 需按运输方式重算的 `RouteSegment`：**5**。
- 需清空无来源通用风险字段的其他节点：**0**。
- 计划指纹：`dcb0af9f6108982b1430b07b67eacdbdb49d0297a5447f1b8a815551e0283d9d`。
...
- 完整 JSON 备份：`artifacts/risk_cleanup_backup_20260726T032112Z.json`。
- 中文统计报告：`artifacts/risk_recalculation_report_20260726T032112Z.md`。
