...
def list_locations() -> list[dict[str, Any]]:
    return run_query(
        ...
        RETURN elementId(location) AS element_id,
               ...
               coalesce(location.location_aliases,[]) AS location_aliases,
               ...
               location.country_name_en AS country_name_en,location.country_name_zh AS country_name_zh,
               coalesce(location.country_aliases,[]) AS country_aliases,
               location.country_naming_version AS country_naming_version,
